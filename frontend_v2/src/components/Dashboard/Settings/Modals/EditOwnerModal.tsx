...
export default function EditOwnerModal({
  ...
  const validateForm = (): boolean => {
    ...
    const firstNameResult = validateRequired(firstName, 'First name');
    if (!firstNameResult.isValid) {
      newErrors.firstName = firstNameResult.error!;
    }

    const lastNameResult = validateRequired(lastName, 'Last name');
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="px-6 pb-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent bg-white ${
                errors.firstName ? 'border-red focus:ring-red' : 'border-gray-200'
              } ${isRTL ? "text-right" : "text-left"}`}
              placeholder={t("settings.firstNamePlaceholder", "أدخل الاسم الأول")}
            />
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              {t("settings.lastName", "اسم العائلة")}
            </label>
            <input
              type="text"
              value={lastName}
              ...
              className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent bg-white ${
                errors.lastName ? 'border-red focus:ring-red' : 'border-gray-200'
              } ${isRTL ? "text-right" : "text-left"}`}
              placeholder={t("settings.lastNamePlaceholder", "أدخل اسم العائلة")}
            />
          ...
          <div>
            ...
            <input
              ...
              placeholder={t("settings.emailPlaceholder", "example@email.com")}
            />
          ...
          <div>
            ...
            <input
              ...
              placeholder={t("settings.phonePlaceholder", "0123456789")}
            />
