...
export default [
    ...
    route("quiz/:quizId/review/:attemptId", "routes/Quiz/review.tsx"),
    route("student/dashboard", "routes/student/dashboard.tsx"),
    route("student/learning", "routes/student/learning.tsx"),
    ...
    layout("routes/dashboard.tsx", [
        ...
        route("dashboard/learning", "routes/dashboard/learning.tsx"),
